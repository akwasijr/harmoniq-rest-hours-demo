...
const FIELD_APP_PRESETS: Partial<Record<IndustryCode, FieldAppQuickActionId[]>> = {
  ...
  maritime: ["my_tasks", "report_incident", "checklists", "risk_check", "browse_assets", "news"],
};
...
const FIELD_APP_TIPS: FieldTipDefinition[] = [
  ...
  },
  {
    industries: ["maritime"],
    translations: {
      en: "Log your rest hours daily and check for compliance before the 48-hour deadline.",
      es: "Registra tus horas de descanso diariamente y verifica el cumplimiento antes del plazo de 48 horas.",
      de: "Erfasse deine Ruhezeiten taeglich und pruefe die Einhaltung vor der 48-Stunden-Frist.",
      fr: "Enregistrez vos heures de repos quotidiennement et verifiez la conformite avant la date limite de 48 heures.",
      nl: "Registreer je rusturen dagelijks en controleer de naleving voor de deadline van 48 uur.",
      sv: "Registrera dina vilotimmar dagligen och kontrollera efterlevnaden innan 48-timmarsfristen.",
    },
  },
];
