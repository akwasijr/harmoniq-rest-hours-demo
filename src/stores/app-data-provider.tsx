...
import { RestHoursRecordsProvider } from "@/stores/rest-hours-store";
import { VesselsProvider } from "@/stores/vessels-store";
import { VoyagesProvider } from "@/stores/voyages-store";
import { CrewAssignmentsProvider } from "@/stores/crew-assignments-store";
...
const APP_DATA_PROVIDERS: DataProvider[] = [
  ...
  RestHoursRecordsProvider,
  VesselsProvider,
  VoyagesProvider,
  CrewAssignmentsProvider,
];
