...
> = {
  ...
  SE: {
    ...
    maritime: "AFS / Transportstyrelsen / MLC 2006",
  },
  GB: {
  ...
  DE: {
    ...
    maritime: "SeeArbG / MLC 2006 / STCW",
  },
  FR: {
    ...
    maritime: "Code des transports / MLC 2006 / STCW",
  },
  ES: {
    ...
    maritime: "Ley 31/1995 / MLC 2006 / STCW",
  },
};
...
> = {
  ...
  maritime:        { icon: "Anchor",          color: "#0369A1", label_key: "industry_templates.maritime.name" },
};
...
// ==========================================
// 12. MARITIME (6 templates)
// ==========================================

const maritimeTemplates: IndustryChecklistTemplate[] = [
  {
    id: "maritime_bridge_watch",
    industry: "maritime",
    name_key: k("maritime", "bridge_watch", "name"),
    description_key: k("maritime", "bridge_watch", "description"),
    category: "navigation_safety",
    regulation: "STCW Code A-VIII/2",
    frequency: "per_shift",
    tags: ["bridge", "navigation", "watchkeeping"],
    items: [
      item("maritime", "bridge_watch", "nav_equipment", "yes_no_na", 1),
      item("maritime", "bridge_watch", "radar_ais", "yes_no_na", 2),
      item("maritime", "bridge_watch", "comms_test", "yes_no_na", 3),
      item("maritime", "bridge_watch", "weather_check", "yes_no_na", 4),
      item("maritime", "bridge_watch", "chart_update", "yes_no_na", 5),
      item("maritime", "bridge_watch", "notes", "text", 6, false),
    ],
  },
  {
    id: "maritime_fire_drill",
    industry: "maritime",
    name_key: k("maritime", "fire_drill", "name"),
    description_key: k("maritime", "fire_drill", "description"),
    category: "emergency_preparedness",
    regulation: "SOLAS III/19.3",
    frequency: "monthly",
    tags: ["fire", "drill", "emergency", "SOLAS"],
    items: [
      item("maritime", "fire_drill", "alarm_test", "yes_no_na", 1),
      item("maritime", "fire_drill", "muster_time", "number", 2),
      item("maritime", "fire_drill", "equipment_check", "yes_no_na", 3),
      item("maritime", "fire_drill", "crew_participation", "yes_no_na", 4),
      item("maritime", "fire_drill", "notes", "text", 5, false),
    ],
  },
  {
    id: "maritime_lifeboat",
    industry: "maritime",
    name_key: k("maritime", "lifeboat", "name"),
    description_key: k("maritime", "lifeboat", "description"),
    category: "life_saving",
    regulation: "SOLAS III/20",
    frequency: "weekly",
    tags: ["lifeboat", "LSA", "safety", "SOLAS"],
    items: [
      item("maritime", "lifeboat", "davit_condition", "pass_fail", 1),
      item("maritime", "lifeboat", "release_mechanism", "pass_fail", 2),
      item("maritime", "lifeboat", "provisions", "yes_no_na", 3),
      item("maritime", "lifeboat", "engine_start", "pass_fail", 4),
      item("maritime", "lifeboat", "notes", "text", 5, false),
    ],
  },
  {
    id: "maritime_ism_audit",
    industry: "maritime",
    name_key: k("maritime", "ism_audit", "name"),
    description_key: k("maritime", "ism_audit", "description"),
    category: "management_system",
    regulation: "ISM Code",
    frequency: "quarterly",
    tags: ["ISM", "audit", "management", "compliance"],
    items: [
      item("maritime", "ism_audit", "policy_available", "yes_no_na", 1),
      item("maritime", "ism_audit", "procedures_current", "yes_no_na", 2),
      item("maritime", "ism_audit", "nc_followup", "yes_no_na", 3),
      item("maritime", "ism_audit", "crew_awareness", "rating", 4),
      item("maritime", "ism_audit", "notes", "text", 5, false),
    ],
  },
  {
    id: "maritime_enclosed_space",
    industry: "maritime",
    name_key: k("maritime", "enclosed_space", "name"),
    description_key: k("maritime", "enclosed_space", "description"),
    category: "confined_space",
    regulation: "MSC.1/Circ.1401",
    frequency: "per_event",
    tags: ["enclosed", "confined", "atmosphere", "permit"],
    items: [
      item("maritime", "enclosed_space", "risk_assessment", "yes_no_na", 1),
      item("maritime", "enclosed_space", "atmosphere_test", "pass_fail", 2),
      item("maritime", "enclosed_space", "ventilation", "yes_no_na", 3),
      item("maritime", "enclosed_space", "rescue_plan", "yes_no_na", 4),
      item("maritime", "enclosed_space", "personnel_standby", "yes_no_na", 5),
      item("maritime", "enclosed_space", "notes", "text", 6, false),
    ],
  },
  {
    id: "maritime_mooring",
    industry: "maritime",
    name_key: k("maritime", "mooring", "name"),
    description_key: k("maritime", "mooring", "description"),
    category: "deck_operations",
    regulation: "MSC.1/Circ.1620",
    frequency: "per_event",
    tags: ["mooring", "deck", "berthing", "lines"],
    items: [
      item("maritime", "mooring", "line_condition", "pass_fail", 1),
      item("maritime", "mooring", "winch_brake", "pass_fail", 2),
      item("maritime", "mooring", "snap_back_zones", "yes_no_na", 3),
      item("maritime", "mooring", "comms_confirmed", "yes_no_na", 4),
      item("maritime", "mooring", "notes", "text", 5, false),
    ],
  },
];
...
export const industryTemplatePacks: IndustryTemplatePack[] = [
  ...
  {
    industry: "maritime",
    name_key: "industry_templates.maritime.name",
    description_key: "industry_templates.maritime.description",
    templates: maritimeTemplates,
  },
];
